 ...
 */
#ifndef __HAI_TIMEOP_H__
#define __HAI_TIMEOP_H__
#include "haibase.h"
...
public:
	S_TIMEX(void){m_Second=0,m_MS=0;}
	S_TIMEX(S_TIME Second){m_Second=Second,m_MS=0;}
};
...
public:
	...
	static S_TIMEX *TimeNow(S_TIMEX &timeX);
